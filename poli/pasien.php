...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['id'])) {
        ...
        $id = $_POST['id'];
        $update_query = "UPDATE pasien SET nama=?, alamat=?, no_hp=? WHERE id=?";
        ...
        $insert_query = "INSERT INTO pasien (nama, alamat, no_hp) VALUES (?, ?, ?)";
...
if (isset($_GET['aksi']) && $_GET['aksi'] == 'hapus' && isset($_GET['id'])) {
    ...
    if(mysqli_query($mysqli, $delete_query)) {
        // Redirect kembali ke halaman pasien setelah penghapusan
        header("Location: index.php?page=pasien");
        exit();
    } else {
...
<div class="container">
    ...
    <div class="row">
        <div class="col">
            <form class="form" method="POST" action="index.php?page=pasien">
                <?php
                $nama = '';
                $alamat = '';
                $no_hp = '';
